...
const validateToken = async (req, res, next) => {
    ...
    if (!authHeader || !authHeader.startsWith("Bearer ")) {
        throw new AppError("User is not authorized or token is missing", constants.UNAUTHORIZED);
    }
    ...
    try {
        ...
        if (typeof decoded === "string" || typeof decoded.userId !== "string") {
            throw new AppError("User is not authorized or token is invalid", constants.UNAUTHORIZED);
        }
